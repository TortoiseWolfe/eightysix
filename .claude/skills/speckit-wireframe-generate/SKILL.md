...
> **eightysix note:** this project uses two-level feature paths —
...
>
> - Shipped validator: `.specify/extensions/wireframe/scripts/validate.py`
> - Config overrides: `.specify/extensions/wireframe/wireframe-config.yml`
> - Sync script: `scripts/sync-wireframes.sh` (emits to `public/wireframes/`
>   for the `/wireframes` Next.js route).
> - Reference SVG: `features/foundation/003-user-authentication/wireframes/01-registration-sign-in.svg`
