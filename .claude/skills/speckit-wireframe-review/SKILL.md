...
description:
  Review wireframes, classify issues as PATCH or REGENERATE, sign off approved
...
> **eightysix note:** wireframes live at `features/<category>/<NNN-name>/wireframes/`
...
> `features/<cat>/<NNN-name>/spec.md` under `## UI Mockup`.
