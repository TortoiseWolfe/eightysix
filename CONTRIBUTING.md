# Contributing to eightysix

Thank you for your interest in contributing to eightysix. This guide will help you get started.
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/eightysix.git
cd eightysix

# 3. Add upstream remote
git remote add upstream https://github.com/ORIGINAL_OWNER/eightysix.git
...
eightysix uses the SpecKit workflow for feature development:
...
- **Questions**: Open a [Discussion](https://github.com/OWNER/eightysix/discussions)
- **Bugs**: Open an [Issue](https://github.com/OWNER/eightysix/issues)
...
Thank you for contributing to eightysix!
