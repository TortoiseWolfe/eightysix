...
eightysix includes a privacy-conscious Google Analytics 4 (GA4) integration that respects user consent and provides comprehensive tracking capabilities for understanding user behavior.
