...
docker compose exec eightysix pnpm test src/utils/consent
docker compose exec eightysix pnpm test src/contexts/Consent
docker compose exec eightysix pnpm test src/components/privacy

# Run integration tests
docker compose exec eightysix pnpm test src/tests/consent
