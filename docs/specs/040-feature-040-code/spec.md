...
| **SC-006** | Logger 100% test coverage           | `docker compose exec eightysix pnpm test --coverage src/lib/logger/`                                                                                                 | Statements, branches, functions, lines all 100%           |
| **SC-007** | All tests pass                      | `docker compose exec eightysix pnpm test`                                                                                                                            | Exit code 0, all tests pass                               |
| **SC-008** | TypeScript compiles                 | `docker compose exec eightysix pnpm run type-check`                                                                                                                  | Exit code 0, no errors                                    |
