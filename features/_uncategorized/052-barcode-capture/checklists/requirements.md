# Specification Quality Checklist: Barcode Capture
...
- Interactive clarification waived at user request ("ship to preview");
  decisions carried from the fork-planning session are recorded in the
  Clarifications section. Revisit before /speckit.plan if the team's
  preview feedback challenges any assumption.
