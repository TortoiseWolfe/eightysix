#!/bin/bash
# Context window monitor for eightysix multi-terminal workflow
...
SESSION="eightysix"
PROJECT_DIR="$HOME/repos/000_Mega_Plates/eightysix"
...
case "${1:-}" in
  ...
  --help|-h)
    ...
    echo ""
    echo "Monitor context window usage across all eightysix terminals."
    echo ""
    echo "Commands:"
