...
| 0    | Success                                                 |
| 1    | Invalid arguments                                       |
| 2    | Re-rebrand scenario (no eightysix found), user declined |
| 3    | Git not installed or not a git repo                     |

## Output Format

```
Rebranding eightysix → MyApp
Owner: myuser
...
Renaming files...
  ✓ eightysixLogo.tsx → MyAppLogo.tsx
  ✓ LayeredeightysixLogo.tsx → LayeredMyAppLogo.tsx
...
If grep finds 0 occurrences of "eightysix":

```
WARNING: This repository appears to have been rebranded already.
No "eightysix" references found.
