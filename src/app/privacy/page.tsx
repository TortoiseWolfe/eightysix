...
export const metadata: Metadata = {
  title: 'Privacy Policy - eightysix',
  description:
    'Learn how eightysix protects your privacy and handles your personal information.',
};
    ...
    <main className="container mx-auto max-w-4xl px-4 py-6 sm:py-8 md:py-12">
      ...
      <article className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Welcome to eightysix. We are committed to protecting your privacy
