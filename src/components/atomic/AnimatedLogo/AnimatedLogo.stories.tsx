  ...
  render: () => (
    <div className="flex flex-col gap-8">
      <div>
        ...
        <AnimatedLogo text="eightysix" size="2xl" />
      </div>
      <div className="flex flex-col gap-4">
        <p className="text-base-content/80 text-sm">All sizes</p>
        <AnimatedLogo text="eightysix" size="sm" />
        <AnimatedLogo text="eightysix" size="md" />
        <AnimatedLogo text="eightysix" size="lg" />
        <AnimatedLogo text="eightysix" size="xl" />
      </div>
      <div>
