...
const meta = {
  ...
  argTypes: {
    speed: {
      control: { type: 'select' },
      options: ['slow', 'normal', 'fast', 2, 5],
    },
    size: {
      control: { type: 'select' },
      options: ['sm', 'md', 'lg', 'xl', 128],
    },
    direction: {
      control: { type: 'radio' },
...
// Layered eightysix Logo as the primary/default story
...
// Layered eightysix Logo - the new composite logo
export const Layeredeightysix: Story = {
  args: {
    children: null,
  },
  render: () => (
...
export const LayeredeightysixLarge: Story = {
  args: {
    children: null,
  },
  render: () => (
...
export const WithText: Story = {
  args: {
    children: <span className="text-primary text-4xl font-bold">REACT</span>,
    size: 'lg',
  },
};
...
export const WithEmoji: Story = {
  args: {
    children: <span className="text-6xl">⚛️</span>,
    size: 'lg',
    speed: 'normal',
  },
};
...
export const LoadingIndicator: Story = {
  args: {
    children: (
      <div className="border-primary h-full w-full rounded-full border-4 border-t-transparent" />
    ),
    size: 48,
    speed: 0.75,
  },
...
export const MultipleLogos: Story = {
  ...
  render: () => (
    <div className="flex items-center gap-8">
      <SpinningLogo size="sm" speed="slow">
        <ReactLogo />
      </SpinningLogo>
      <SpinningLogo size="md" speed="normal">
        <ReactLogo />
      </SpinningLogo>
      <SpinningLogo size="lg" speed="fast">
        <ReactLogo />
      </SpinningLogo>
    </div>
  ),
