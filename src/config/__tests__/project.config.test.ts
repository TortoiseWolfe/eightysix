...
describe('Project Configuration', () => {
  ...
  describe('getProjectConfig', () => {
    it('should return default configuration when no environment variables are set', () => {
      ...
      expect(config.projectName).toBe('eightysix');
  ...
  describe('generateManifest', () => {
    it('should generate a valid PWA manifest', () => {
      ...
      expect(manifest.name).toContain('eightysix');
      expect(manifest.short_name).toBe('eightysix');
  ...
  describe('projectConfig singleton', () => {
    it('should export a singleton configuration object', () => {
      ...
      expect(projectConfig.projectName).toBe('eightysix');
